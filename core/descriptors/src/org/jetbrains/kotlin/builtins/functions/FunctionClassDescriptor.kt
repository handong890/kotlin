...
public class FunctionClassDescriptor(
    ...
    private inner class FunctionTypeConstructor : AbstractClassTypeConstructor() {
        ...
        private val supertypes = storageManager.createLazyValue {
            ...
            // Add unnumbered base class, e.g. Function for Function0
            add(containingDeclaration, Name.identifier(functionKind.classNamePrefix)) { superParameters ->
            ...
            // For K*Functions, add corresponding numbered Function class, e.g. Function2 for KFunction2
